    ...
    < >
      <div className="bg-white">
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl py-10 sm:py-10 lg:py-10 lg:grid gap-x-12 lg:max-w-6xl lg:grid-cols-4 ">
            ...
            <div className=" p-5 grid grid-row-4 rounded bg-gray-100">
              <div className="">
              ...
              <div className="">
                <dt className="text-base font-semibold leading-7 text-gray-900">
                  Anita Max Wynn Quis tellus eget adipiscing convallis sit
                </dt>
              </div>
          ...
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-7xl">
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-3 lg:gap-y-16">
              {featuress.map((feature) => (
                <div key={feature.name} className=" p-5 grid grid-row-4 rounded bg-gray-100">
