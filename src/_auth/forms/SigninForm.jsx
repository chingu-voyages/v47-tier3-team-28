  ...
  return (
    <Grid container style={{ backgroundColor: "#20876E" }}>
      ...
      <Paper elevation={0} style={{ ...paperStyle, background: "transparent", boxShadow: "none" }}>
          ...
          <form>
            <TextField fullWidth placeholder="Enter your username" margin="normal" InputProps={{ style: inputPropsStyle }} 
            ...
            <Grid container spacing={2} justifyContent={{ xs: 'center', md: 'flex-start' }} marginTop="normal">
                <Grid item xs={8} lg={8} md={6}>
                  
                    <p style={{marginTop: '20px'}}>I forgot my password, click here to reset</p>
